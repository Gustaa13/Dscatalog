...
import com.gustaa13.dscatalog.dto.UserUpdateDTO;
...
public class UserResource {
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<UserDTO> update(@Valid @PathVariable Long id, @Valid @RequestBody UserUpdateDTO userUpdateDTO) {
